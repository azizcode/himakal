...
<?php 
		echo "<MARQUEE><b>
Selamat Datang Di Website Himakal UIN Maulana Malik Ibrahim Malang </b>
</MARQUEE>"; ?>	
...
elseif ($_GET['module']=='detailberita'){
 ...
 //untuk addthis [http://aleezone.co.nr]
	echo "<span class=posting><!-- AddThis Button BEGIN -->
		<a class=\"addthis_button\" href=\"http://www.addthis.com/bookmark.php?v=250&amp;username=xa-4cb573150125639e\"><img src=\"http://s7.addthis.com/static/btn/v2/lg-share-en.gif\" width=125 height=16 alt='Bookmark and Share' style=\"border:0\"/></a>
		<script type=\"text/javascript\" src=\"http://s7.addthis.com/js/250/addthis_widget.js#username=xa-4cb573150125639e\"></script>
		<!-- AddThis Button END --></span><br>";	
...
elseif ($_GET['module']=='hubungikami'){
  ...
  echo "<ul> <b>Jika Anda mempunyai pertanyaan, saran, maupun kritik yang sifatnya konstruktif, silakan layangkan melalui form di bawah ini.</b></span><br /><br />
       </ul><hr color=#CCC noshade=noshade />
       <pre><b>Alamat  :  Jl. Kertosariro RT 2 RW 2 No. 15B Malang 65144, Indonesia</b></pre>
	   <pre><b>Telepon : (0341) 554306 </b></span></pre>
